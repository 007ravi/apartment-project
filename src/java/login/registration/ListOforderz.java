...
public class ListOforderz extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
          ...
          Connection conn = DBConnection.getConnection();
             String quet="select * from appdata where request=(?)";
             ...
             while(resultSet.next())
             {
                ...
                Arr2.add(new ListingBean(resultSet.getString("image"),resultSet.getString("roomid"),resultSet.getString("email_1"),resultSet.getString("state"),resultSet.getString("Address"),resultSet.getString("Bedroom"),resultSet.getString("request"),resultSet.getString("request_status")));
             }
