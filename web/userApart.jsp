...
<nav class="navbar navbar-inverse">
  <div class="container-fluid" >
    <div class="navbar-nav mr-auto">
      <a class="navbar-brand" href="front.jsp">APARTMENT-GURU</a>
    </div>
  </div>
</nav>
<div class="container">
...
<div class="row">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		<center><form id="form" action="AppartmentMain" method="post" enctype="multipart/form-data">
                        <h1 align="center" style="color:black">FILL YOUR DETAILS</h1>
			<fieldset>
			...
			<!--	<div class="form-group">
				...
				<div class="form-group">
                    <input type="email" name="Email" class="form-control input-lg" placeholder="Email Address" value=<%=s%> >
				</div>
				<div class="form-group">
                    <input type="text" name="bedroom" class="form-control input-lg" placeholder="No of Bedrooms" required>
				</div>
				<div class="form-group">
