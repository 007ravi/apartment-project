...
%>
      ...
      <font color="White">
         ...
         <span style="float:right;color: white;margin: 15px 10px 0px 0px;" id="time"></span>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="villa1.jsp">10k-20k</a>
                    <a href="villa1.jsp">20k above</a>
                </div>
            </div> 
       ...
       <div>
        ...
        <option value="chandigarh" onselect="Submit">CHANDIGARH</option>
          ...
          <video width="500" height="300" controls="autoplay">
            ...
            <source src="video3.mp4" type="video/mp4">
                ...
                <div class="division" style = "background-color:black;font-family:Calibri;width:100%;">
                    <br><p style = "text-align:center;font-size:15px;color:white;">APARTMENTGURU© 2019 All rights reserved. </p>
                    <p style = "text-align:right;font-size:15px;color:white;">Designed by : Ravi Mishra<img src = "user.png" height = 25px width="25px"></p>
                    <p style = "text-align:right;font-size:15px;color:white;">Contact us : APARTMENTGURU@gmail.com&nbsp<a href = "mailto:mishra007ravi@gmail.com"><img src = "gmail.png" height = 25px width="25px"></a> </p>
